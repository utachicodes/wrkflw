...
func TestPlanCatalogDefinesLaunchLimits(t *testing.T) {
	...
	if free.Lists != 5 || free.ActiveItemsPerList != 20 || free.Agents != 1 || free.StoredTasks != 500 || free.StoredContentBytes != 10*1024*1024 || free.APITokens != 3 {
	...
	if pro.Lists != 45 || pro.ActiveItemsPerList != 20 || pro.Agents != 5 || pro.StoredTasks != 10_000 || pro.StoredContentBytes != 250*1024*1024 || pro.APITokens != 20 {
